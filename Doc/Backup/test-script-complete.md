# Complete Test Script for MP3 to Subtitle Conversion

## Instructions
1. Copy the code below and save it as `test_mp3_to_subtitle.py` in the SRT-Generator directory
2. Run the script with: `srt_env\Scripts\python test_mp3_to_subtitle.py`
...
1. Open Command Prompt in the SRT-Generator directory
...
4. Check the results in:
   ...
   - Detailed report in `test_report.json`

## Expected Output Files

The test will generate the following files:
